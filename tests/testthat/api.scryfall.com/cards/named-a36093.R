structure(list(url = "https://api.scryfall.com/cards/named?fuzzy=asdf", 
    status_code = 404L, headers = structure(list(date = "Wed, 05 Jan 2022 05:17:46 GMT", 
        ...
        via = "1.1 vegur", `cf-cache-status` = "HIT", age = "5038", 
        `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"", 
        `report-to` = "{\"endpoints\":[{\"url\":\"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=wZBEUr40lifX0FCMx0Bpw2397CQCBwqEO3FBvqAwNBgxpMIvyW8y%2BGu2uRpI78XSHNiPEwE8H9aF5nG%2BXxBk6Y%2BgwdjaCq8V%2BKulO2qCXSTSu3g%2F0xaZOCxRd3kVuXilb4YCC1tlc6MVAwt0U%2BY%3D\"}],\"group\":\"cf-nel\",\"max_age\":604800}", 
        nel = "{\"success_fraction\":0,\"report_to\":\"cf-nel\",\"max_age\":604800}", 
        server = "cloudflare", `cf-ray` = "6c8a3dfe2a7b4edd-GRU", 
