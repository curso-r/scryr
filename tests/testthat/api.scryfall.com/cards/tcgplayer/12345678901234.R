structure(list(url = "https://api.scryfall.com/cards/tcgplayer/12345678901234", 
    status_code = 404L, headers = structure(list(date = "Wed, 05 Jan 2022 05:17:48 GMT", 
        ...
        via = "1.1 vegur", `cf-cache-status` = "HIT", age = "5035", 
        `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"", 
        `report-to` = "{\"endpoints\":[{\"url\":\"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=xvqIaREsJ8dspXzHdNKqgoAnqCUSOtn2y3L%2ByL9iojcOknTa01gIkocGPnM1RZSuWZ7zOlG6G4WlkwsxXRlRqXFES8rIWBbD%2BgHw9S3d%2FSjHCE2dSV83QgzSNLMbJz6H3KSmDHmKrQACRubgY0M%3D\"}],\"group\":\"cf-nel\",\"max_age\":604800}", 
        nel = "{\"success_fraction\":0,\"report_to\":\"cf-nel\",\"max_age\":604800}", 
        server = "cloudflare", `cf-ray` = "6c8a3e0a09194edd-GRU", 
    ...
    connect = 0.000112, pretransfer = 0.000317, starttransfer = 0.015953, 
    total = 0.016102)), class = "response")
