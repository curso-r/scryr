structure(list(url = "https://api.scryfall.com/cards/arena/12345678901234", 
    status_code = 404L, headers = structure(list(date = "Wed, 05 Jan 2022 05:17:48 GMT", 
        ...
        `report-to` = "{\"endpoints\":[{\"url\":\"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=UZCm7VB6AGMT2pC3tliQkWAffa0Z%2FLL5KIvOAAvZpSn9I7fnoc98aLmZweroXxA0%2FZNC1SUzjSY3nfIy0bktVK2rZGsBx6fS8%2B3mz%2FPwyO19dLgoft3jK9%2BTIeKcnXbCTAUlHI%2FXXu4kfgouNCQ%3D\"}],\"group\":\"cf-nel\",\"max_age\":604800}", 
        nel = "{\"success_fraction\":0,\"report_to\":\"cf-nel\",\"max_age\":604800}", 
        server = "cloudflare", `cf-ray` = "6c8a3e090fe64edd-GRU", 
    ...
    connect = 6.9e-05, pretransfer = 0.000246, starttransfer = 0.019317, 
    total = 0.019449)), class = "response")
