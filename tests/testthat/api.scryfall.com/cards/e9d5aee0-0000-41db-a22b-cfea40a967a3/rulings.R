structure(list(url = "https://api.scryfall.com/cards/e9d5aee0-0000-41db-a22b-cfea40a967a3/rulings", 
    status_code = 404L, headers = structure(list(date = "Wed, 05 Jan 2022 05:18:49 GMT", 
        ...
        via = "1.1 vegur", `cf-cache-status` = "HIT", age = "447", 
        `expect-ct` = "max-age=604800, report-uri=\"https://report-uri.cloudflare.com/cdn-cgi/beacon/expect-ct\"", 
        `report-to` = "{\"endpoints\":[{\"url\":\"https:\\/\\/a.nel.cloudflare.com\\/report\\/v3?s=uvJfYNSusM78YKpzCz5dUPFyBUrwpKoreYmbbD3XQ2iL6QyJCg%2BWnEmxfqUmxsopb2j%2FI4Q8KAnSki3Tye012Ivk4KRQtZ43%2FC%2FhV8tfHh1OepxiYql2GPaLE6vBXIhxKP70JRlWanzzKtvTcQM%3D\"}],\"group\":\"cf-nel\",\"max_age\":604800}", 
        nel = "{\"success_fraction\":0,\"report_to\":\"cf-nel\",\"max_age\":604800}", 
        server = "cloudflare", `cf-ray` = "6c8a3f86fda54edd-GRU", 
    ...
    connect = 0.000122, pretransfer = 0.000359, starttransfer = 0.017714, 
    total = 0.017852)), class = "response")
