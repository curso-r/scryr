---
title: "Overview of scry"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Overview of scry}
...
scry is a lightweight wrapper around [Scryfall](https://scryfall.com/)'s, an
amazing (and free!) _Magic: The Gathering_ API. With scry you can ingest card
...
This is a result of Scryfall's data model and is the reason why scry needs
...
# Using a name
scry_card_named("Anje Falkenrath")$name
...
also has an endpoint that tries to autocomplete the name of a card and scry
...
short demonstration of what else you can do with the rest of scry:
