...
endpoints available as simple functions that any R programmer can use; results
are also wrapped as data frames for maximum compatibility with common data
...
scry makes it easy to process _Magic_ cards' data programatically.
...
There are many other endpoints that also support fully tidyverse compatible
analyses. A complete list can be found on scry's
