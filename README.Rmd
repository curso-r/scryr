...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/scry)](https://CRAN.R-project.org/package=scry)
...
scry makes it easy to process _Magic_ cards' data programmatically. There are
many endpoints that fully support tidyverse compatible analyses. For more
information, start with `vignette("scry")` or the [full
